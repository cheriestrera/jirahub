...
class DeleteEmployeeWindow(Frame):
    ...
    def place_widgets(self):
        ...
        entry_image_1 = safe_photoimage("entry_1.png")
        ...
        image_image_4 = safe_photoimage("image_4.png")
        ...
        self.entry_bg_1 = self.canvas.create_image(892.0, 320.0, image=entry_image_1)
        ...
        # Decorative Images
        self.image_1 = self.canvas.create_image(580.0, 407.0, image=image_image_1)
        self.image_2 = self.canvas.create_image(582.0, 446.0, image=image_image_2)
        self.image_3 = self.canvas.create_image(481.0, 433.0, image=image_image_3)
        self.image_4 = self.canvas.create_image(481.0, 459.0, image=image_image_4)
    ...
    def search_employee(self):
        ...
        if doc.exists:
            ...
            self.label_email.config(text=data.get('email', ''))
            ...
            self.label_email.config(text="{Employee Email}")
    ...
    def delete_employee(self):
        ...
        if not emp_id or emp_id == self.entry_1.placeholder:
            messagebox.showerror("Error", "Please enter an Employee ID")
            return
        doc_ref = self.db.collection("employees").document(emp_id)
...
# For SceneManager integration, do NOT run Tk() here.
# Example scene registration in main.py:
